...
-(void)wby_setShadowOffsetWithPaintingWidth:(CGFloat)paintingWidth paintingHeight:(CGFloat)paintingHeight  X:(CGFloat )X Y:(CGFloat)Y layerColor:(UIColor*)layerColor  shadowOpacity:(CGFloat)shadowOpacity  shadowRadius:(CGFloat)shadowRadius  shadowOffset:(CGSize)shadowOffset{
    ...
    self.layer.shadowColor = layerColor.CGColor;
    //阴影的透明度
    ...
    //添加直线
    [path addLineToPoint:CGPointMake(paintingWidth /2, -Y)];
    [path addLineToPoint:CGPointMake(paintingWidth +X, -X)];
    [path addLineToPoint:CGPointMake(paintingWidth +Y, paintingHeight /2)];
    [path addLineToPoint:CGPointMake(paintingWidth +X, paintingHeight +X)];
    [path addLineToPoint:CGPointMake(paintingWidth /2, paintingHeight +Y)];
    [path addLineToPoint:CGPointMake(-X, paintingHeight +X)];
    [path addLineToPoint:CGPointMake(-Y, paintingHeight /2)];
    [path addLineToPoint:CGPointMake(-X, -X)];
