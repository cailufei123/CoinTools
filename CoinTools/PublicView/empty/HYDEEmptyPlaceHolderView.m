...
float const width_bt                 = 112.0 ;
float const height_bt                = 42.0 ;
float const fontSize_bt              = 16.0 ;

#import "HYDEEmptyPlaceHolderView.h"
#import <UIColor+YYAdd.h>

@interface HYDEEmptyPlaceHolderView ()
...
@implementation HYDEEmptyPlaceHolderView
...
- (void)layoutSubviews {
    ...
    rectButton.origin.y = rectContentLabel.origin.y + rectContentLabel.size.height + flexY_lb_bt+15 ;
...
- (void)configure {
//    self.backgroundColor = hydeColor(@"") ;
}
...
//        [_reloadButton setTitleColor:[UIColor colorWithHexString:hydeColorfff] forState:0] ;
        _reloadButton.titleLabel.font = [UIFont normalFontOfSize:15 WithFontType:Normal];
        _reloadButton.backgroundColor = [UIColor colorWithHexString:hydeColorBlue];
        _reloadButton.layer.cornerRadius = 21.0f ;
