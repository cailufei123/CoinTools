...
//shapeLayer.frame = CGRectMake(self.imageView.easyS_x, self.imageView.easyS_y, self.imageView.easyS_width+3,  self.imageView.easyS_width+3) ;
////
////    CGFloat cp = layerRadius+3/2.f
//UIBezierPath *p = [UIBezierPath bezierPathWithArcCenter:self.imageView.center radius:layerRadius startAngle:.0f endAngle:.75f*M_PI clockwise:YES];
...
//    self.imageView.backgroundColor = [UIColor blueColor];
    CGFloat layerRadius = self.imageView.easyS_width/2*1.0f ;
    shapeLayer.frame = CGRectMake(-5, -5, self.imageView.easyS_width+10,  self.imageView.easyS_width+10);
//    shapeLayer.backgroundColor = [UIColor blackColor].CGColor;
    CGFloat cp = (self.imageView.easyS_width+20)/2.f;
    UIBezierPath *p = [UIBezierPath bezierPathWithArcCenter:CGPointMake(cp, cp) radius:layerRadius+4 startAngle:.0f endAngle:.75f*M_PI clockwise:YES];
    shapeLayer.path = p.CGPath;
...
//        [_imageView imageWithRenderingMod:UIImageRenderingModeAlwaysOriginal];
